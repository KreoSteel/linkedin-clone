                  ...
                  {userSkills.length > 0 ? (
                     <div className="flex flex-wrap gap-2">
                        {userSkills.slice(0, 5).map((userSkill: UserSkillType) => (
                           <span
                              key={userSkill.id}
                              className="px-3 py-1.5 bg-neutral-100 text-neutral-700 rounded-full text-base font-medium">
                              {userSkill.name}
                           </span>
                        ))}
                        {userSkills.length > 5 && (
                           <span className="px-3 py-1.5 bg-primary-50 text-primary-600 rounded-full text-base font-medium">
