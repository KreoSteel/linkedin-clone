...
export default function ExperienceModal({ isEditing = false, experience }: ExperienceModalProps) {
                ...
                <DialogContent>
                    ...
                    <form action={editFormAction} className="flex flex-col gap-2.5">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Input type="text" name="location" variant="form" required defaultValue={experience.location || ""} />
                        </div>
                        <div className="flex flex-col gap-2">
